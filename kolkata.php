...
<div class="container">
  ...
  <!-- Main -->
  <div class="main">
    <h2>Hotels in Noida(137 Nivaas)</h2>

    <div class="hotel-card">
      <img src="img/hotel8.avif" alt="Hotel">
      <div class="hotel-info">
        <h2>Collection O Sector 70 Noida</h2>
        <div class="rating">4.5 ★</div>
        <p>Delhi 110005 • 1.1 km away</p>
        <p>Free Wifi • Geyser • Reception</p>
        <p class="price">₹3999 <small>+ ₹100 taxes</small></p>
        <a href="booking.php" class="btn">Book Now</a>
      </div>
    </div>
    <div class="hotel-card">
      <img src="img/hotel9.avif" alt="Hotel">
      <div class="hotel-info">
        <h2>Hotel O Expo Mart Ansal Golf Link 1 </h2>
        <div class="rating">4.5 ★</div>
        <p>Delhi 110005 • 3 km away</p>
        <p>Free Wifi • Geyser • Reception</p>
        <p class="price">₹2999 <small>+ ₹151 taxes</small></p>
        <a href="booking.php" class="btn">Book Now</a>
      </div>
    </div>
    <div class="hotel-card">
      <img src="img/hotel10.jpg" alt="Hotel">
      <div class="hotel-info">
        <h2>Super Townhouse Sector 121 Noida</h2>
        <div class="rating">4.9 ★</div>
        <p>Delhi 110005 • 2 km away</p>
        <p>Free Wifi • Geyser • Reception</p>
        <p class="price">₹4452 <small>+ ₹222 taxes</small></p>
        <a href="booking.php" class="btn">Book Now</a>
      </div>
    </div>
    <div class="hotel-card">
      <img src="img/hotel11.avif" alt="Hotel">
      <div class="hotel-info">
        <h2>Hotel O Sector 121 Gaur City Mall N</h2>
        <div class="rating">3.5 ★</div>
        <p>Delhi 110005 • 4.6 km away</p>
        <p>Free Wifi • Geyser • Reception</p>
    ...
    <div class="hotel-card">
      <img src="img/hotel12.avif" alt="Hotel">
      <div class="hotel-info">
        <h2>Townhouse Sector 51 Noida Near Metro Station</h2>
        <div class="rating">4.5 ★</div>
        <p>Delhi 110005 • 1.4 km away</p>
        <p>Free Wifi • Geyser • Reception</p>
        <p class="price">₹4999 <small>+ ₹100 taxes</small></p>
        <a href="booking.php" class="btn">Book Now</a>
      </div>
    </div>
    <div class="hotel-card">
      <img src="img/hotel13.avif" alt="Hotel">
      <div class="hotel-info">
        <h2>Hotel O Quadis</h2>
        <div class="rating">4.9 ★</div>
        <p>Delhi 110005 • 1.1 km away</p>
        <p>Free Wifi • Geyser • Reception</p>
    ...
    <div class="hotel-card">
      <img src="img/hotel14.avif" alt="Hotel">
      <div class="hotel-info">
        <h2>Hotel O Aagman place</h2>
        <div class="rating">3.5 ★</div>
        <p>Delhi 110005 • 1.1 km away</p>
        <p>Free Wifi • Geyser • Reception</p>
    ...
    <div class="hotel-card">
      <img src="img/hotel15.avif" alt="Hotel">
      <div class="hotel-info">
        <h2>Nivaas Palace</h2>
        <div class="rating">3.5 ★</div>
        <p>Delhi 110005 • 1.1 km away</p>
    ...
    <div class="hotel-card">
      <img src="img/hotel16.avif" alt="Hotel">
      <div class="hotel-info">
        <h2> Swagat Palace</h2>
        <div class="rating">4.5 ★</div>
        <p>Delhi 110005 • 3.1 km away</p>
        <p>Free Wifi • Geyser • Reception</p>
    ...
    <div class="hotel-card">
      <img src="img/hotel17.avif" alt="Hotel">
      <div class="hotel-info">
        <h2>Hotel O Ashoka Inn Hotel</h2>
        <div class="rating">3.5 ★</div>
